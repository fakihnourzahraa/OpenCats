...
<?php TemplateUtility::printHeader('Candidates', array( 'js/jquery-1.3.2.min.js','js/highlightrows.js', 'js/export.js', 'js/dataGrid.js', 'js/dataGridFilters.js', 'js/shortlist.js')); ?>
