    ...
    public function getDataGridDefinition($uniqueIndex, $data, $db)
{
    ...
    {
        case DATA_ITEM_JOBORDER:  $column = 'joborder.joborder_id';  break;
        case DATA_ITEM_CANDIDATE: $column = 'candidate.candidate_id'; break;
        case DATA_ITEM_CONTACT:   $column = 'contact.contact_id';    break;
        case DATA_ITEM_COMPANY:
        default:                  $column = 'company.company_id';    break;
    }
